...
<head>
  ...
  <title>美得你退出</title>
  <meta name="keywords" content="美得你,供应链系统">
  <meta name="description" content="美得你供应链系统退出">
...
<div id=loginCont class="middle-box text-center loginscreen  animated fadeInDown" style="width:400px">
		...
		<h3><img src="/static/admin/img/logoutSuccess.png" style="margin-top: -14px;">&nbsp;&nbsp;您已成功退出美得你供应链系统  <a href="/index">重新登录</a></h3>
</div>
</body>
</html>
