...
<div id="container" class="wrapper wrapper-content animated fadeInRight">
                                    ...
                                    <span class="input-group-btn">
                                            <web-uploader :target-id="'webuploader0'"
                                              ...
                                              <button id="imageUpload" type="button"
                                                      class="btn btn-sm btn-primary">上传文件</button>
                                            </web-uploader>
                                        </span>
                                </div>
                                <div
    ...
    <div class="ibox">
        <div class="ibox-title">校验结果</div>
        <div class="ibox-content">
            <div>
                <p v-for="item in checkResult">{{item}}</p>
            </div>
        </div>
    </div>
</div>
...
<script src="/static/admin/js/apps/prod/product/prodcheck.js?v=ea38b0f7"></script>