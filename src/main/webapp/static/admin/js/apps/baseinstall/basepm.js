(function () {
    var base = Vue.extend({
        ...
        methods: {
            ...
            save: function () {
                ...
                self.$validate(true, function () {
                    ...
                    if (self.$validation.valid && self.baseMain.feeType) {
                        self.disabled = true;
                        self.baseMain.metarialType = 'MAIN';
            ...
            fetchList: function () {
                var self = this;
                self.$http.get('/api/material/baseMain/findAll?contractId=' + self.contractId + '&metarialType=MAIN')
                    .then(function (res) {
                        if (res.data.code == 1) {
            ...
            feeSummaryForType: function () {
                var self = this;
                self.$http.get('/api/material/baseMain/feeSummaryForType?contractId=' + self.contractId + '&metarialType=MAIN')
                    .then(function (res) {
                        if (res.data.code == 1) {
    ...
    Vue.component('basedata-basepm', base);
})()