...
public abstract class ReflectionUtils {
	...
	public static void setFieldValue(final Object obj, Field field, final Object value) {
		if (field == null) {
			throw new IllegalArgumentException("Could not find this field  on target [" + obj + "]");
		}
		try {
			field.set(obj, value);
		} catch (IllegalAccessException e) {
	 ...
	 * 如向上转型到Object仍无法找到, 返回null.
	 */
	public static Field getAccessibleField(final Class clz, final String fieldName) {
		assertHasText(fieldName, "fieldName:" + fieldName);
