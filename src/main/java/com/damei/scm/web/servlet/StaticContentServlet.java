 ...
 *******************************************************************************/
package com.damei.scm.web.servlet;
 ...
 * <p>
 * 演示访问地址为：
 * static-content/{contentPath}
 * static-content/{contentPath}?download=true
 *
 * @author calvin
 */
...
public class StaticContentServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        // 取得参数(contentPath就是数据库中保存的路径，不包括servletPath 例如：/product/2014/09/10/16.jpg)
